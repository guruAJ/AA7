...
namespace IHSDC.WebApp.Controllers
{
    ...
    public class AccountController : BaseController
    {
...

        {
            ...
            //var loggedinUser = await UserManager.FindAsync("clk4", "Admin123!");
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    var UnitName = _db.Users.FirstOrDefault(i => i.UserName == model.Username).EstablishmentFull;
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        // var callbackUrl = Url.Action("ConfirmEmail", "Account", new { userId = user.Id, code = code }, protocol: tRequest.Url.Scheme);
