...
namespace IHSDC.Common.Configurations
{
    ...
    public class Application
    {
        ...
        public const string ApplicationRedirectURL = "http://localhost:44344/test/loginHelper.aspx";
        public const string ApplicationRedirectAppURL = "http://localhost:44344/test/appMain.aspx";
